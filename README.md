...
[Blokken](https://github.com/pcordemans/blokken) is a Blockly-based programming environment. These exercises are an intuitive introduction in programming language constructs. This course is no longer actively maintained by its author, but shared freely. So feel free to use the course or even contribute to it. 
...
https://devbit-git-course.netlify.com/collaborating/#forking-and-pull-requests
